...
public class WRDRequest {
    ...
    public String lon;
    public String ls_point;
    public String remarks;
    public String sluice;
    public String txn_date;
    public String txn_id;
    public String village;
    public String nof_mem;
    public String wua_name;
    ...
    public String getLs_point() {
        return ls_point;
    }

    public void setLs_point(String ls_point) {
        this.ls_point = ls_point;
    }
    ...
    public String getSluice() {
        return sluice;
    }

    public void setSluice(String sluice) {
        this.sluice = sluice;
    }
    ...
    public String getNof_mem() {
        return nof_mem;
    }

    public void setNof_mem(String nof_mem) {
        this.nof_mem = nof_mem;
    }

    public String getWua_name() {
        return wua_name;
    }

    public void setWua_name(String wua_name) {
        this.wua_name = wua_name;
    }
