...
public class BlockAdapter extends BaseAdapter {
    List<BlockData> data;
    public List<BlockData> SubjectListTemp;
    public List<BlockData> MainList;
    public BlockAdapter.SubjectDataFilter subjectDataFilter;
    Context context;

    public  BlockAdapter(Context context, List<BlockData> data) {
        this.context = context;
        this.data = data;
        this.SubjectListTemp = new ArrayList<BlockData>();
        this.SubjectListTemp.addAll(data);
        this.MainList = new ArrayList<BlockData>();
    ...
    public Filter getFilter() {
        ...
        if (subjectDataFilter == null) {
            ...
            subjectDataFilter = new BlockAdapter.SubjectDataFilter();
        }
    ...
    private class SubjectDataFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence charParentID) {
            ...
            if (charParentID != null && charParentID.toString().length() > 0) {
                ArrayList<BlockData> arrayList1 = new ArrayList<BlockData>();

                for (int i = 0, l = MainList.size(); i < l; i++) {
                    BlockData subject = MainList.get(i);

                    String valueOfParet = String.valueOf(subject.getDISTRICT_ID());
        ...
        protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
            ...
            SubjectListTemp = (ArrayList<BlockData>) filterResults.values;
